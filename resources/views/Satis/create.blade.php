        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form action="{{route('satis.store')}}" method="POST" class="form-horizontal" id="ajax-form">
                        {{csrf_field()}}
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="span11" name="adet" value=""/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">İndirim Oranı</label>
                            <div class="controls">
                                <input type="text" class="span11" name="i_orani" value=""/>
                            </div>
                        </div>
